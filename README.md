...
Internal inventory and rental management system. The application helps employees manage company equipment, rent available gear, and leverage AI for semantic search.
...
| File                                                       | What it covers                                                                     |
| ---------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| [docs/PLAN_AI_SUGGESTIONS.md](docs/PLAN_AI_SUGGESTIONS.md) | Original project plan and suggestions generated by AI.                             |
| [docs/PLAN.md](docs/PLAN.md)                               | Final implementation plan, must-have features, business rules, and MVP decisions.  |
| [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md)               | System architecture, technology choices, data models, and design decisions.        |
| [docs/FEATURES.md](docs/FEATURES.md)                       | Detailed walkthrough of implemented features.                                      |
...
| [docs/TRADE_OFFS.md](docs/TRADE_OFFS.md)                   | Honest summary of implemented features, shortcuts, missing items, and 24h roadmap. |
| [docs/REQUIREMENTS.md](docs/REQUIREMENTS.md)               | Checklist mapping requirements to implementation artifacts.                        |
